...
def test_rmap_get_link_success(client, mock_rmap):
    """Test the normal Message 2 flow."""
    ...
    mock_rmap.handle_message2.assert_called_once_with({"payload": "valid_msg2_payload"})
...
@patch("server.src.server.IdentityManager")
@patch("server.src.server.RMAP")
